...
@Entity
@Table(name = "backup_stock", catalog = "hibernate", uniqueConstraints = {
        @UniqueConstraint(columnNames = "T1_STOCK_NAME"),
        @UniqueConstraint(columnNames = "T1_STOCK_CODE")})
public class StockBackUp implements java.io.Serializable {
    ...
    public StockBackUp(String stockCode, String stockName) {
