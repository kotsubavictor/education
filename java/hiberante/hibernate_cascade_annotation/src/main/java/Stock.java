...
public class Stock implements java.io.Serializable {
    ...
    //    todo: CascadeType.PERSIST does not work
    //    todo: we have to use hibernate annotation for cascade
    @OneToMany(fetch = FetchType.LAZY, mappedBy = "stock", cascade = CascadeType.PERSIST)
