...
@NamedNativeQueries({
        @NamedNativeQuery(
                name = "findStockByStockCodeNativeSQL3",
                query = "select * from stock s where s.T1_STOCK_CODE = :stockCode",
                resultClass = Stock3.class
        )
})
@Entity
...
public class Stock3 implements java.io.Serializable {
    ...
    public Stock3(String stockCode, String stockName) {
